...
Reverse-engineer **the target URL or URLs provided by the user** into the current Next.js application. Preserve
...
- Run `npm run cloner -- selftest` before trusting a new instrument. If an
...
in `docs/research/CLONE_BOOTSTRAP_REFERENCE.md`. Follow its live model catalog,
...
npm run cloner -- measure --target clone --url <clone-origin> --site <site-key> --routes <route,...> --inventory
SOURCE_RUN=20260914T120000Z_source_0123abcd
CLONE_RUN=20260914T120100Z_clone_89abcdef
npm run cloner -- audit dead-controls --site <site-key> --target source --run "$SOURCE_RUN" --profile .cloner-profiles/primary
SOURCE_AUDIT=20260914T120200Z_audit-controls_2345bcde
npm run cloner -- audit dead-controls --site <site-key> --target clone --run "$CLONE_RUN"
CLONE_AUDIT=20260914T120300Z_audit-controls_3456cdef
npm run cloner -- audit dead-classes --site <site-key> --target clone --run "$CLONE_RUN"
